...
startButton.addEventListener("click", () => {
    ...
    if (input== ""){
        ...
        document.body.innerHTML = "<div class='wrapper'><h2 class='question'>Hello "+input+ "❤️! Do You Love me?</h2>"+
...
function yesButtonListener(){
    document.body.innerHTML = "<div class='wrapper'><h2 class='question'>Yay! Thank you for loving me ❤️, "+input+ " - My Pyala sa Pandaa 🐼❤️🎀🌍!</h2>"+
